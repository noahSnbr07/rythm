...
export default async function getYouTubeSongsByQuery(query: string): Promise<APIResponseSongTemplate[] | null> {
   ...
   if (response.ok) {
      ...
      const templateSongs: APIResponseSongTemplate[] = data.items.map((song: any) => ({
